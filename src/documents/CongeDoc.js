            ...
            <View style={styles.containerTwo}>
                <View style={styles.section}>
                    ...
                    <Text style={styles.pCertifText}>
                        ...
                        d'un {props.typeConge} de (<Text style={fontStyles.bold}>{props.duration}</Text>) {props.duration > 1 ? "jours" : "jour"} {props.type === "Contractuelle"+props.duration > 1 ? "s" : "" ? "ouvrable" : ""},
